-- Ctrl+h/j/k/l navigation and Alt+h/j/k/l resizing across NeoVim splits
-- and herdr panes. The plugin detects herdr itself (HERDR_ENV): inside a
-- herdr pane it hands off at split edges; elsewhere (SSH, containers) it
-- simply navigates NeoVim windows.
return {
